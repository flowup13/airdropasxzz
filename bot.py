...
📘By Participating you are agreeing to the {COIN_NAME} (Airdrop) Program Terms and Conditions. Please see pinned post on group for more information.
...
✏️ Mandatory Tasks:
🔹 Join our Telegram Channel & Telegram Group
🔹 Follow & Retweet, like and share our pinned tweet on Twitter
🔹 Join us on Discord 
🔹 Subscribed, likes and share our video on Youtube 
...
JOIN_DISCORD_TEXT = f'''
🔹 Join our Discord & Subscribed, likes and share our video on Youtube
{DISCORD_LINKS}
'''
...
Don't forget to:
🔸 Stay in the telegram groups & channels
